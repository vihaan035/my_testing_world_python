...
def myCommand():
    ...
    try:
        ...
        speak('Sorry Sir! didn\'t get that! Try typing the command!')
        ...
        if 'open youtube' in query:
            ...
            if 'MI' in recipient:
                try:
                    ...
                    server.ehlo()
                    server.starttls()
                    server.login("Sirgupta035@gmail.com", 'onlysecret@123')
                    server.sendmail("Sirgupta035@gmail.com", "rajeshgpec@gmail.com", content)
                    server.close()
                    speak('Email sent!')
